...
*
*/
extern BPGame * bp_create(int nrows, int ncols); //finished in mine
...
*			
*/
extern BPGame * bp_create_from_mtx(char mtx[][MAX_COLS], int nrows, int ncols);//finished in mine
...
*
*/
extern void bp_destroy(BPGame * b); //finished in mine
...
*
*/
extern void bp_display(BPGame * b); //finished in mine
...
*
*/
extern int bp_pop(BPGame * b, int r, int c); //sohum
...
*
*/
extern int bp_is_compact(BPGame * b); //me
...
*   configuration).
*/
extern void bp_float_one_step(BPGame * b); //me
...
*
*/
extern int bp_score(BPGame * b); //sohum
...
*
*/
extern int bp_get_balloon(BPGame * b, int r, int c); //me
...
*/
extern int bp_can_pop(BPGame * b); //finished in mine
...
*
*/
extern int bp_undo(BPGame * b); //both
